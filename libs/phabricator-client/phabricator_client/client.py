...
Config is injected: pass a :class:`PhabricatorSettings`, or let the client build
one from the environment when none is provided. The API is synchronous; async
callers should run it in a threadpool.
"""
...
class PhabricatorClient:
    def __init__(self, settings: PhabricatorSettings | None = None) -> None:
        self.settings = settings or PhabricatorSettings()
